...
@pytest.mark.testcase
@allure.title("修改待办内容,在弹窗中点击取消，关闭弹窗,修改待办部分内容，点击确定")
@allure.description("修改待办内容,在弹窗中点击取消，关闭弹窗,修改待办部分内容，点击确定")
...
# 修改待办日期，点击确定
@pytest.mark.testcase
@allure.title("修改待办日期，点击确定")
@allure.description("修改待办日期，点击确定")
...
# 删除设置日期的待办
@pytest.mark.testcase
@allure.title("删除设置日期的待办")
@allure.description("删除设置日期的待办")
def test_del_agent():
    poco("待办").click()
    poco(text="请在下方书写待办或点击此处新建待办").click()
...
# 按紧迫程度排序-今天
@pytest.mark.testcase
@allure.title("按紧迫程度排序-今天")
@allure.description("按紧迫程度排序-今天")
...
@pytest.mark.testcase
@allure.title("按紧迫程度排序-当前时间与待办时间相差24小时的待办，再按创建时间排序")
@allure.description("按紧迫程度排序-当前时间与待办时间相差24小时的待办，再按创建时间排序")
...
@pytest.mark.testcase
@allure.title("待办列表新增待办，选择日期时间并选择待办提醒，查看待办提醒")
@allure.description("待办列表新增待办，选择日期时间并选择待办提醒，查看待办提醒")
...
@pytest.mark.testcase
@allure.title("断网情况下，创建待办，创建完成后重新联网")
...
@pytest.mark.testcase
@allure.title("按紧迫程度排序-当前时间与待办时间不满24小时但过凌晨逾期待办，再按创建时间排序")
@allure.description("按紧迫程度排序-当前时间与待办时间不满24小时但过凌晨逾期待办，再按创建时间排序")
...
@pytest.mark.testcase
@allure.title("按紧迫程度排序-待办-还有不到十天，再按创建时间排序")
@allure.description("按紧迫程度排序-待办-还有不到十天，再按创建时间排序")
...
# 新增超长文本内容待办
@pytest.mark.testcase
@allure.title("新增超长文本内容待办")
@allure.description("新增超长文本内容待办")
def test_add_long_text_agent():
    poco("待办").click()
    poco(text="请在下方书写待办或点击此处新建待办").click()
    text(
        "我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办我要添加一个超长文本的代办",
        enter=False)
    poco(text="确认").click()
    sleep(2)
    poco(desc="").click()
...
#     poco("待办").click()
#     poco(text="列表视图").click()
#     if exists(Template(r"tpl1751012774976.png", record_pos=(0.448, -0.073), resolution=(1200, 1920))):
